...
namespace AssetImportTool
{
	public class DefaultTextureImporter : IAssetImporterExtension
	{
		...
		private int streamingMipmapsPriority;
		...
		{
			var importer = (TextureImporter)originalImporter;
			...
			foreach(var property in properties){
				switch (property.name) {
					...
					case "streamingMipmaps":
						importer.streamingMipmaps = bool.Parse (property.value);
						break;
						
					case "streamingMipmapsPriority":
						importer.streamingMipmapsPriority = int.Parse (property.value);
						break;
