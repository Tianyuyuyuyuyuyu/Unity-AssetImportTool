	...
	public class DefaultImporterCreater : Editor
	{
		...
		private static void OnCreate()
		{
			...
			if (string.IsNullOrEmpty (directoryPath)) {
				EditorUtility.DisplayDialog ("错误", "请选中文件夹执行命令！", "确定");
				return;
			}

			// 取得Unity Editor内的AsseetImporter继承类
		...
		private static void Create(string directoryPath, System.Type type)
		{
			...
			output.AppendLine ("namespace AssetImportTool");
			output.AppendLine ("{");
